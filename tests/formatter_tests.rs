...
mod format_tests {
    ...
    fn test_weekday_and_week_number_directives() {
        ...
        assert_eq!(
            sun.to_str_lite("%A", Lang::En).unwrap().as_str().unwrap(),
            "Sunday"
        );
        assert_eq!(
            sun.to_str_lite("%a", Lang::En).unwrap().as_str().unwrap(),
        ...
        assert_eq!(
            sun.to_str_lite("%w", Lang::En).unwrap().as_str().unwrap(),
            "0"
        );
        assert_eq!(
            sun.to_str_lite("%u", Lang::En).unwrap().as_str().unwrap(),
            "7"
        );
        ...
        assert_eq!(
            mon.to_str_lite("%A", Lang::En).unwrap().as_str().unwrap(),
            "Monday"
        );
        assert_eq!(
            mon.to_str_lite("%w", Lang::En).unwrap().as_str().unwrap(),
            "1"
        );
        assert_eq!(
            mon.to_str_lite("%u", Lang::En).unwrap().as_str().unwrap(),
            "1"
        );
        assert_eq!(
            mon.to_str_lite("%V", Lang::En).unwrap().as_str().unwrap(),
            "01"
        );
        assert_eq!(
            mon.to_str_lite("%G", Lang::En).unwrap().as_str().unwrap(),
            "2024"
        );
        assert_eq!(
            mon.to_str_lite("%g", Lang::En).unwrap().as_str().unwrap(),
        ...
        assert_eq!(
            sat.to_str_lite("%w", Lang::En).unwrap().as_str().unwrap(),
            "6"
        );
        assert_eq!(
            sat.to_str_lite("%U", Lang::En).unwrap().as_str().unwrap(),
            "00"
        );
        assert_eq!(
            sat.to_str_lite("%W", Lang::En).unwrap().as_str().unwrap(),
        ...
        assert_eq!(
            w53.to_str_lite("%V", Lang::En).unwrap().as_str().unwrap(),
            "53"
        );
        assert_eq!(
            w53.to_str_lite("%G", Lang::En).unwrap().as_str().unwrap(),
            "2015"
        );
        ...
        assert_eq!(
            dec30.to_str_lite("%V", Lang::En).unwrap().as_str().unwrap(),
            "01"
        );
        assert_eq!(
            dec30.to_str_lite("%G", Lang::En).unwrap().as_str().unwrap(),
            "2025"
        );
        assert_eq!(
            dec30.to_str_lite("%g", Lang::En).unwrap().as_str().unwrap(),
