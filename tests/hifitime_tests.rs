...
mod tests {
    use deep_time::{Dt, Scale, constants::ATTOS_PER_SEC_I128, leap_seconds};
    ...
    fn test_utc_leap_second() {
        ...
        let our_tai = Dt::from(hifitime_tai_attos(hi_utc), Scale::TAI);
    ...
    fn test_multiple_leap_second_dates() {
        ...
        for &(year, month, day, hour, min, sec, expected_offset) in cases {
            ...
            let my_offset = leap_seconds::leap_sec(&my_utc, true).offset as i32;
