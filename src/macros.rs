...
//! ## Import paths
//!
//! Prefer importing macros from this module:
//!
//! ```
...
//! Prefer explicit imports to avoid short-name clashes.
//!
//! ## How they work
//!
...
//! use deep_time::macros::{as_sec, dt, from_sec, from_ymd, ms, ns, sec};
//!
...
/// ```
/// use deep_time::{Dt, Scale};
/// use deep_time::macros::{days_f, from_jd};
///
/// // 2_460_782.25
...
/// ```
/// use deep_time::{Dt, Scale};
/// use deep_time::macros::{days_f, from_jd_f};
///
/// // 2_460_782.25
...
/// ```
/// use deep_time::{Dt, Scale};
/// use deep_time::macros::{days_f, from_mjd};
///
...
/// ```
/// use deep_time::{Dt, Scale};
/// use deep_time::macros::{days_f, from_mjd_f};
///
/// // 60_961.25
